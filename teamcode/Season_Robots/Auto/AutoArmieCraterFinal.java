...
@Autonomous(name = "AutoArmieCraterFinal", group = "Armiebot_Auto")
public class AutoArmieCraterFinal extends LinearOpMode {
    ...
    private void right() {
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 1)) {
            telemetry.addData("Where", "Right Step : 10 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }

        //Stop, Extend Arm, and Lower lift
        motorFrontRight.setPower(0);
        motorFrontLeft.setPower(0);
        motorBackLeft.setPower(0);
        motorBackRight.setPower(0);
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 6)) {
            telemetry.addData("Where", "Right Step : 11 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
        ...
        LiftArm.setPower(0);
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 999)) {
            telemetry.addData("Where", "Right Step : 12 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
    }
    ...
    private void center(){
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 1)) {
            telemetry.addData("Where", "Center Step : 9 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 6)) {
            telemetry.addData("Where", "Center Step : 10 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 999)) {
            telemetry.addData("Where", "Center Step : 11 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
    }
...
/*        //Move Forward
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 1)) {
            telemetry.addData("Where", "Left Step : 10 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 6)) {
            telemetry.addData("Where", "Left Step : 11 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
        ...
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 999)) {
            telemetry.addData("Where", "Left Step : 12 %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }
    }
}
