...
@Disabled
@TeleOp (name = "Armiebot_Sensing", group = "Armiebot_WIP_Folder")
public class Armiebot_Sensing extends LinearOpMode {
    ...
    private void initVuforia() {
        ...
        while (opModeIsActive()){
            if (gamepad1.a && currentstep == 0){
                parameters.cameraDirection = VuforiaLocalizer.CameraDirection.FRONT;
                currentstep = 1;
            }
            if (gamepad1.a && currentstep == 1){
